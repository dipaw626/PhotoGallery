...
<body>
    ...
    <hr>
    <pre>
        <form action="<?= site_url('home/aksi_simpan_gallery'); ?>" method="POST" enctype="multipart/form-data">
        Nama Gallery        : <input type="text" name="name_gallery" required|trim|min_length[]>
        <?= form_error('name_gallery', '<small class="text-danger pl-3">', '</small>'); ?>
        Foto        : <input type="file" name="name_foto" id="name_foto" >
...
<!-- <div id="wrapper"> -->
<!-- Begin Page Content -->
<!-- <div class="container-fluid" style="padding-bottom: 20%; background: url('<?= base_url('assets'); ?>/img/bg-crud5.jpg');"> -->

<!-- Page Heading -->


<!-- <h1 class="h3 mb-4" align="center" style="color: floralwhite; padding-bottom: 4%; "><br><br><br><?= $title; ?></h1> -->

<!-- <div class="row">
                <div class="col-lg-11">

                    <?= form_open_multipart('home/aksi_simpan_gallery'); ?>

                    <div class="row mb-5">
                        <label for="name_gallery" class="col-sm-2 col-form-label" style="color: floralwhite;">Nama Foto</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="name_gallery" id="name_gallery"">
                            <?= form_error('name_gallery', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                    </div>
                    <div class=" row mb-5">
...
<!-- <div class="col-sm-12">
                                        <div class="input-group mb-3">
                                            <input type="file" class="form-control" id="name_foto" name="name_foto" for=name_foto">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10" style="padding-bottom: 5%;">
                                <input type="text" class="form-control" style="padding-bottom: 5%;" name="deskripsi" id="deskripsi">
                                <?= form_error('deskripsi', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                        </div>
                    </div>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <div class="row justify-content-md-center" style="padding-bottom: 250px;">
                <div class="card rounded-lg shadow" style="width: 30rem">
                    <div class="card-header text-center card-header-light">
                        <h5 class="text-secondary">Tambah Foto</h5>
                        <img src="<?= base_url('assets/'); ?>img/logo.png" class="logo mt-2 mb-2" alt="Nostra Gallery Logo" />
                    </div>
                    <div class="card-body">
                        <?= form_open_multipart('home/aksi_simpan_gallery'); ?>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Nama Foto</label>
                            <input type="text" class="form-control" id="name_gallery" name="name_gallery" placeholder="........" />
                        </div>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="9"></textarea>
                        </div> -->
                        <center>
